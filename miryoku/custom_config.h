...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,              &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp RIGHT,         &kp PG_DN,         \
&kp LALT,          &kp RALT,          &kp LCTRL,         &kp LSHFT,         &kp LGUI,          U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             \
...
U_NP,                  U_NP,                 U_NA,              U_NA,             U_NA,             U_NA,                   U_NA,                     U_NA,          U_NP,                     U_NPdfdf
